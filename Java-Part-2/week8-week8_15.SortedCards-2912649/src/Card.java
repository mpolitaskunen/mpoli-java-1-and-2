public class Card implements Comparable<Card> {
    ...
    public int compareTo(Card card) {
        if(this.value == card.value && this.suit > card.suit || this.value > card.value) {
            return 1;
        } else if (this.value == card.value && this.suit < card.suit || this.value < card.value) {
            return -1;
        } else if (this.value == card.value && this.suit == card.suit) {
            return 0;
        } else {
            return -1;
        }
